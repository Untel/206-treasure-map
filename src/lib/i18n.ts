...
export const UI_MESSAGES: Record<Locale, Messages> = {
  en: {
    ...
    overlapHint: 'This square overlaps an existing blocked area. Move at least 25 units away on both axes.',
    firebaseHint:
  ...
  ja: {
    ...
    overlapHint: 'この区画は既存のブロック範囲と重なります。両軸で少なくとも 25 離してください。',
    firebaseHint:
  ...
  vi: {
    ...
    overlapHint: 'Ô này chồng lên vùng đã bị chặn. Hãy cách ít nhất 25 đơn vị trên cả hai trục.',
    firebaseHint:
